...
public class TomatoCrop: CropBase, IPlayerInteractable
{
    ...
    protected override void Start()
    {
        ...
        render.materials[3].SetFloat(IPlayerInteractable.outlineThickness, 0.01f);
    }
    ...
    {
        if(!render) return;
        render.materials[3].SetColor(IPlayerInteractable.outlineColor, isHovered ? (grown() ? Color.white: Color.black): Color.clear);
    }
